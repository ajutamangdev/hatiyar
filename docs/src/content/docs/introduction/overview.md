---
title: Overview
description: Introduction to Hatiyar - security toolkit
---

## What is hatiyar?

**hatiyar** is a security toolkit designed for penetration testing, vulnerability assessment, and security research. Built for security professionals, it provides a comprehensive set of tools with an interactive shell, production-ready exploit modules, enumeration capabilities, and a modern CLI.
