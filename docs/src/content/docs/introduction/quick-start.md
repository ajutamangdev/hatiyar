...
The quickest way to get started is via pip:

```bash
pip install hatiyar
```

For other installation methods (development setup, containers, etc.), see the [Installation Guide](/introduction/installation/)
