...
1. **[Quick Install (pip)](#quick-install-pip)** - Fastest way to get started (recommended for users)
2. **[Development Setup (git + Makefile)](#development-setup)** - For contributors and advanced users
3. **[Manual Setup](#manual-setup-without-makefile)** - Full control over the installation
4. **[Container Setup](#container-setup-dockerpodman)** - Isolated environment with Docker/Podman
