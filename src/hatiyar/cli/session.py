...
from hatiyar.core.constants import Context, K8sAuthOptions
...
class CLISession:
    ...
    K8S_GLOBAL_OPTIONS: List[str] = field(default_factory=lambda: [
    ...
    AWS_GLOBAL_OPTIONS: List[str] = field(default_factory=lambda: [
        "AWS_PROFILE",
        "AWS_REGION",
        "ACCESS_KEY",
        "SECRET_KEY",
    ...
    def get_module_info(self, module_name: Optional[str] = None) -> Optional[Dict[str, Any]]:
        """Get module info."""
